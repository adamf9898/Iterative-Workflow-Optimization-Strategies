...
1. **Review the Framework**: Start with [docs/framework-overview.md](docs/framework-overview.md)
2. **Understand Iterative Tasks**: Read [docs/iterative-tasks.md](docs/iterative-tasks.md)
3. **Explore Examples**: Check practical applications in the [examples/](examples/) directory
4. **Use Templates**: Adapt templates from [templates/](templates/) to your needs
